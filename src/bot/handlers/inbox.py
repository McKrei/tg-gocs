...
from src.agent.tools import find_similar_document, get_unique_filename
from src.bot.handlers.callbacks import _delete_old_document, _format_gdrive_result
from src.bot.keyboards import get_inbox_confirmation_keyboard, get_inbox_duplicate_keyboard
from src.bot.states import InboxStates
from src.services.sync import InboxFile, get_inbox_files, process_inbox_file
...
async def handle_inbox_skip(callback: types.CallbackQuery, state: FSMContext) -> None:
    ...
    from src.drive.client import delete_drive_file
