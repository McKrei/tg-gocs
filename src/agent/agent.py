    ...
    messages: list[dict[str, Any]] = [
        {
            ...
            "content": (
                ...
                "Твоя задача — проанализировать документ, определить его владельца (owner), "
                "категорию (category) и составить метаданные.\n\n"
                "ПРАВИЛА ОПРЕДЕЛЕНИЯ КАТЕГОРИИ И ВЛАДЕЛЬЦА:\n"
                "1. Владелец (owner): Укажи имя или роль человека, которому принадлежит документ "
                "(например, 'Евгений', 'Виктория', 'Общее'). "
                "Извлеки имя из ФИО в документе. Если документ принадлежит конкретному человеку, "
                "старайся писать его реальное имя (например, 'Виктория' или 'Евгений') "
                "вместо общих ролей (Муж/Жена), особенно если в существующей структуре или БД "
                ...
                "(например, 'Личные документы/Виктория'), ДАЖЕ ЕСЛИ её пока нет в списке "
                "существующих папок. "
                "Категорически запрещено помещать документы одного человека в "
                "личную папку другого человека!\n\n"
                f"{structure_info}\n\n"
                "Извлеки максимум полезных реквизитов из документа: серию, номер, дату выдачи "
                "или регистрации, номер актовой записи, орган выдачи, ФИО, даты рождения, "
                ...
                "- category: строка, относительный путь (например, 'Личные документы/Виктория')\n"
                ...
                "- owner: строка, владелец документа (например, 'Виктория', 'Евгений', 'Общее')\n"
